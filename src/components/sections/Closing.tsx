...
export default function ClosingSection() {
  return (
    <section className="py-24 bg-background-light text-center px-6 relative overflow-hidden">
      <motion.div
      ...
      >
        <div className="space-y-4">
          <p className="text-terracotta text-xs font-black uppercase tracking-[0.4em] mb-4">Terima Kasih</p>
        ...
        <div className="pt-8">
          ...
          <p className="text-terracotta/60 text-xs mt-4 font-medium italic">& Kel. Besar Kedua Mempelai</p>
        </div>
      </motion.div>

      {/* Decorative Elements */}
      <div className="absolute top-0 left-0 w-full h-px bg-linear-to-r from-transparent via-primary/10 to-transparent"></div>
      <div className="absolute -bottom-24 -left-24 size-64 bg-sage/5 rounded-full blur-3xl"></div>
      <div className="absolute -top-24 -right-24 size-64 bg-terracotta/5 rounded-full blur-3xl"></div>
    </section>
  );
}
